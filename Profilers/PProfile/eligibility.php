              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Scholar Number<span class="caret"></span></a></td>
...
$sql = "SELECT * FROM basicdetails where DESC LIMIT $start_from, $num_rec_per_page"; 
...
$hisofbk = $_POST['hob'];
$dety = $_POST['dy'];
$sql = "SELECT * FROM basicdetails where Branch='$branch' and SSLC>='$sslc' and `PU/Dip`>='$puaggregate' and BE>='$beaggregate' and Backlogs='$backlogs' and HofBacklogs='$hisofbk' and DetainYears='$dety'" ; 
 //run the query
